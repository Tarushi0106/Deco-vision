# Deco Vision — Detection (isolated project)
...
# Terminal 3 — Detection backend (this project)
cd detection/backend && venv/Scripts/activate && uvicorn app.main:app --port 8812

# Terminal 4 — Detection frontend (this project)
cd detection/frontend && npm run dev
```
...
`detection/backend`, a build+serve step for `detection/frontend`, and
